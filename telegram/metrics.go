...
var (
	...
	gameCurrentActiveCount = metrics.NewRegisteredCounter("game.current.active", metrics.DefaultRegistry)
	gameCurrentQueuedCount = metrics.NewRegisteredCounter("game.current.queued", metrics.DefaultRegistry)
	gameCurrentQuorumCount = metrics.NewRegisteredCounter("game.current.quorum", metrics.DefaultRegistry)
